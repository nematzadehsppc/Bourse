...
namespace Back.DAL.Migrations
{
    public partial class initDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateSequence(queries.QueryBuilder.spInsertParamValue);
            migrationBuilder.CreateSequence(queries.QueryBuilder.funcAvrageTransactionVolume);
        }
